...
from PIL import Image
import random
from net_deeplapV3_plus import *
import net_deeplapV3_plus as network
...
dataloaders = {#changeBan
    'train': DataLoader(dataload(path='data/train', H=H, W=W,pow_n=6, aug=True) , batch_size=batch_size, shuffle=True, num_workers=4),
    'val': DataLoader(dataload(path='data/val', H=H, W=W, pow_n=6, aug=False), batch_size=batch_size, shuffle=False, num_workers=4)
}
